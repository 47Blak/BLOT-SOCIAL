const ARTICLES = [
  ...
  },
  {
    ...
    "dek": "Nvidia locks down multi-year high-bandwidth memory supply agreements with South Korean chipmaker SK Hynix to secure essential components for its upcoming Vera Rubin AI computing architectures.",
    "author": "亗BLAK",
    "date": "Jul 26",
    "image": "https://media-cldnry.s-nbcnews.com/image/upload/t_fit-1500w,f_auto,q_auto:best/rockcms/2024-02/240223-nvidia-chip-ew-1236p-de5e63.jpg",
    "body": [
      "Artificial intelligence chip powerhouse Nvidia has finalized landmark long-term supply and co-development agreements with leading memory manufacturers, led by South Korea’s SK Hynix, to guarantee the critical high-bandwidth memory (HBM) needed for its next-generation processors.",
      "​The historic multi-year agreement forms part of a broader technology framework announced alongside South Korean industry leaders, aimed at sustaining the massive global buildout of AI data centers and next-generation computing infrastructure.",
  ...
  {
    "slug": "Image of Vinicius junior",
    "category": "Trending",
    "headline": "Arsenal Eye Blockbuster Vinicius Junior Transfer from Real Madrid",
    "dek": "Arsenal are actively exploring a major move for Real Madrid star Vinícius Júnior, whose contract negotiations have stalled, although manager José Mourinho remains determined to retain the prolific Brazilian forward.",
    "author": "亗BLAK",
    "date": "Jul 26",
    "image": "https://media.gettyimages.com/id/2283182176/photo/group-c-fifa-world-cup-2026.jpg?s=594x594&w=gi&k=20&c=-oo4SGVUZDmZ4Cu3wpX4GTU1oKuVEC7XZrrXUWJ3q9M=",
    "body": [
      "​Arsenal have internally greenlit a potential move for Real Madrid forward Vinícius Júnior as they look to strengthen their attacking options. Senior decision-makers at the North London club have approved the pursuit at all levels, recognizing the unique opportunity presented by the Brazilian’s contractual situation in Spain.",
  ...
  },
  {
    ...
    "category": "Business",
    "headline": "Rising Occupancy and Strategic Pricing Drive Record Financial Performance for Top Nigerian Hoteliers",
    "dek": "Publicly listed hospitality giants Transcorp Hotels and Ikeja Hotel deliver a combined half-year net profit of N14.60 billion as surging corporate demand fuels a five-year earnings high.",
    "author": "亗BLAK",
    "date": "Jul 25",
    "image": "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1200&q=80",
    "body": [
      "Nigeria’s hospitality sector is rapidly emerging as one of the standout corporate beneficiaries of the nation’s evolving macroeconomic environment. Publicly listed hotel operators have reported their highest combined earnings growth in five years, effectively insulating themselves from the consumer spending pressures and rising operational inflation that continue to challenge other consumer-facing sectors.",
      "​Financial statements for the first half of 2026 reveal that Transcorp Hotels Plc and Ikeja Hotel Plc posted a combined profit after tax of N14.60 billion. This marks an impressive 24.8 percent increase compared to the N11.79 billion recorded during the same six-month period in 2025, underscoring strong resilience and demand within the premium lodging space.",
      "​Unlike fast-moving consumer goods and beverage manufacturers struggling with weak retail demand, major hoteliers are benefiting directly from a rebound in corporate and institutional activities. A stabilization in exchange rates alongside broader corporate adjustments has triggered a resurgence in executive travel, high-level board meetings, political summits, and major industry conferences across principal urban centers.",
  ...
  },
  {
    ...
    "author": "亗BLAK",
    "date": "Jul 19",
    "image": "https://c8.alamy.com/comp/2A7RMD1/men-garbage-in-masquerade-costume-dancing-to-the-beat-of-the-spirit-during-the-annual-lagos-black-heritage-festival-in-badagry-beach-lagos-2A7RMD1.jpg",
    "body": [
      "The Olubadan of Ibadanland, Oba Rashidi Adewolu Ladoja, has issued a formal directive advising women across designated communities in Ibadan to remain indoors as the revered Oloolu masquerade begins its annual traditional festival on Monday.",
      "​In a official statement released through his Chief Press Secretary, Chief Solomon Ayoade, the monarch emphasized that centuries-old Ibadan customs strictly forbid women from setting eyes on the sacred Oloolu masquerade.",
      "​Beyond the movement restrictions for female residents, the traditional ruler also issued a stern warning against recording, filming, or taking photographs of the masquerade throughout the duration of the traditional rites.",
  ...
  },
  {
    ...
    "category": "Business",
    "headline": "African Refining Titan Dangote Secures Record $2.5 Billion in Landmark Private Equity Capital Raise",
    "dek": "Dangote Petroleum Refinery completes landmark $2.5 billion private equity placement after drawing 3.7 times subscription demand from international, African, and institutional investors.",
    "author": "亗BLAK",
    "date": "Jul 18",
    "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8pXykrRHWT_4XNLWWpxtR3663VbAi523ZzGbn1vRs2BlwVvmCQWJJlME&s=10",
    "body": [
      "Dangote Petroleum Refinery and Petrochemicals FZE has successfully finalized a landmark private equity placement, securing approximately $2.5 billion in fresh capital from a broad coalition of international and continental investors. The capital raise marks the largest disclosed primary equity private placement in Africa's history, signaling a pivotal shift in institutional appetite for large-scale African infrastructure projects.",
      "​The landmark transaction saw unprecedented demand from institutional players, resulting in a subscription rate 3.7 times higher than the initial offer size. The capital injection represents the mega-refinery’s first equity funding round involving external investors, expanding its shareholder register beyond original legacy owners and institutionalizing its governance structure.",
      "​According to official company statements, the $2.5 billion proceeds will be strategically deployed to accelerate ongoing expansion across the refinery and petrochemical complex. In addition to scaling output capacity, the new equity will fortify the enterprise’s balance sheet, optimize its overall capital structure, and provide enhanced liquidity for future industrial initiatives.",
